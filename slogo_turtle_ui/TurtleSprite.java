...
public class TurtleSprite {
	...
	private void initTurtleSprite() {
		...
		turtleImageView.setFitWidth(screenWidth*0.1);
		turtleImageView.setFitHeight(screenHeight*0.1);
	...
	/**
	 * Create mouse click and hover over events to properly highlight this turtle. If right click, shows image gallery that user can choose image from. This image will be turtle's 
	 * new image.
	 */
		...
		EventHandler<MouseEvent> clickHandler = new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent evt) {
            	if (evt.getButton() == MouseButton.PRIMARY) {
            		...
            		ImageGallery images = new ImageGallery(TurtleSprite.this, turtleImageView, myResources.getString("TerrainImageFilePath"));
            	}
            }
        };
	...
	public void setImage(String newImagePath) {
		...
		canvas.getChildren().remove(turtleImageView);
		initTurtleSprite();
	}
	...
	public void setTurtleImageView(ImageView newView) {
		turtleImageView = newView;
	}
